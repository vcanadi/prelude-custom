...
/* package prelude-custom-0.1.0.0 */
#define VERSION_prelude_custom "0.1.0.0"
#define MIN_VERSION_prelude_custom(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "prelude-custom-0.1.0.0-7fdJlYcznjUKvWWQ5x4EHs"

#define CURRENT_PACKAGE_KEY "prelude-custom-0.1.0.0-7fdJlYcznjUKvWWQ5x4EHs"
